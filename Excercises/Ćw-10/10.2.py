...
'''
Algorytmem floyda_warshala zaznaczam w atblicy o rozmiarze NxN zaznaczam czy istnieje krawędz pomiędzy poszczególnymi
wierzchołakmii zamiast zapisywac ich wagi. 
'''
