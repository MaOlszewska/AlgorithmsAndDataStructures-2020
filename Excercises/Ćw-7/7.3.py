...
'''
Sortujemy zadania po zysku w kolejności malejącej, nąstepnie szukamy miejsca wolnego dla zadań.
T = (numer zadania, termin wykonania, zysk)
'''

def maximization_proft(T):
