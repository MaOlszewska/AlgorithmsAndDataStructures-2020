...
w linii prostej pomiędzy miastami liczona w kilometrach wyraża się wzorem len = ( długość odcinka )
...
postanowiono zminimalizować czas pomiędzy otwarciem pierwszej i ostatniej autostrady. Czas budowy autostrady wyrażony w dniach wynosi ⌈len⌉ (sufit z długości autostrady wyrażonej w km). Proszę zaproponować
